...
class ProductServiceTest {
    ...
    void test1() {
        ...
        given(productRepository.findById(productId)).willReturn(Optional.of(product)); // given을 통해 값을 넣어 준다.
    ...
    void test2() {
        // given
        Long productId = 200L;
        int myprice = ProductService.MIN_MY_PRICE - 50; // 최저가 미만으로 변경
        ...
        assertEquals(
                ...
                exception.getMessage() //같다면, 예외처리가 잘 된것이다.
        );
    }
}
